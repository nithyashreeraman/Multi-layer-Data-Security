...
_DECODED_MESSAGE_PATH = "decodedMessage.txt"
_CIPHER_TEXT_PATH = "Output.txt"
...
while(len(PassPhrase)!=16):
    print("Enter in the 16 character passphrase to decrypt your text file %s" %_CIPHER_TEXT_PATH)
    PassPhrase=input()
...
FILEOUT = open(_DECODED_MESSAGE_PATH, 'w', encoding='utf-8')
...
file2=open(_DECODED_MESSAGE_PATH, "r", encoding='utf-8')
